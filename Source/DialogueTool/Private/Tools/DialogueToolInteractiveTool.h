...
#include "DialogueToolInteractiveTool.generated.h"


/**
 * Builder for UDialogueToolInteractiveTool
 */
UCLASS()
class DIALOGUETOOL_API UDialogueToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UDialogueToolInteractiveTool
 */
UCLASS(Transient)
class DIALOGUETOOL_API UDialogueToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UDialogueToolInteractiveToolProperties();
...
/**
 * UDialogueToolInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class DIALOGUETOOL_API UDialogueToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UDialogueToolInteractiveToolProperties> Properties;
