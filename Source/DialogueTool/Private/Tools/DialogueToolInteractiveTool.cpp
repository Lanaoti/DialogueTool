...
#include "DialogueToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UDialogueToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UDialogueToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UDialogueToolInteractiveTool* NewTool = NewObject<UDialogueToolInteractiveTool>(SceneState.ToolManager);
...
UDialogueToolInteractiveToolProperties::UDialogueToolInteractiveToolProperties()
{
...
void UDialogueToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UDialogueToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UDialogueToolInteractiveToolProperties>(this, "Measurement");
...
void UDialogueToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UDialogueToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UDialogueToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UDialogueToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UDialogueToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UDialogueToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UDialogueToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UDialogueToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UDialogueToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
