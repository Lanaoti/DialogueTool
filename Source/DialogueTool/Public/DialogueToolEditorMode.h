...
#include "DialogueToolEditorMode.generated.h"
 ...
 */
UCLASS()
class UDialogueToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_DialogueToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UDialogueToolEditorMode();
	virtual ~UDialogueToolEditorMode();
